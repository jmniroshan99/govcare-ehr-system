-- =====================================================
-- GovCare EHR Complete PostgreSQL Database
...
declare
  ...
  emails text[] := array[
    'superadmin@govcare.lk','admin@govcare.lk','doctor@govcare.lk','nurse@govcare.lk','pharmacist@govcare.lk',
    'lab@govcare.lk','radiology@govcare.lk','reception@govcare.lk','records@govcare.lk','ict@govcare.lk'
  ];
