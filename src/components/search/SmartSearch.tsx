...
import { fetchSmartSearchSuggestions } from "../../services/searchService";
import type { SmartSearchSuggestion } from "../../utils/smartSearch";
...
export function SmartSearch({
  ...
  useEffect(() => {
    ...
    const timer = window.setTimeout(() => {
      void fetchSmartSearchSuggestions(trimmed, limit)
        .then((items) => {
