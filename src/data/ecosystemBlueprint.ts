...
export const ecosystemModules: EcosystemModule[] = [
  {
    ...
    capabilities: ["Firebase Authentication", "Custom claims", "Protected routes", "Session timeout", "Audit-ready login events"],
    roles: ["super_admin", "hospital_admin", "doctor", "nurse", "pharmacist", "lab_technician", "receptionist", "patient"],
    onlineMode: "Firebase Auth verifies identity and role profile before dashboard access.",
