...
export const permissions: Record<Role, string[]> = {
  ...
  ict_admin: ["system:*", "backups:*", "security:read", "api-health:read", "jobs:read", "deployments:read", "notifications:*", "media:read", "audit:read", "settings:*"],
  records_officer: ["patients:*", "future-care:read", "mortuary:read", "reports:export", "media:upload", "media:read", "audit:read"],
  guardian: ["portal:read", "patients:linked", "appointments:linked", "reports:linked", "media:linked"],
...
export const roleGroups = {
  ...
  patient: ["patient", "guardian"] as Role[],
};
