        ...
        <section className="grid gap-4 xl:grid-cols-3">
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              ...
              <p className="help-strip p-3 text-sm">Priority notifications are designed for Firebase Cloud Messaging with audit logs for every alert, call, message, and escalation.</p>
            </CardContent>
          </Card>
        </section>
