    ...
    <PageTransition>
      <div className="space-y-5">
        ...
        <section className="grid gap-4 xl:grid-cols-[420px_1fr]">
          <Card>
            ...
            <CardContent className="space-y-3">
              ...
              <p className="help-strip p-3 text-sm">Production writes should call Cloud Functions to validate patient, referral source, hospitalId, role claims, bed lock, notifications, and auditLogs.</p>
            </CardContent>
          </Card>
        ...
        <section className="grid gap-4 xl:grid-cols-[1fr_380px]">
          ...
          <Card>
            <CardHeader><CardTitle className="flex items-center gap-2"><ShieldAlert className="h-5 w-5 text-primary" />Firebase workflow model</CardTitle></CardHeader>
            <CardContent className="space-y-3 text-sm">
              {[
                ...
                "`approveAdmissionAndAssignBed` Cloud Function validates under-10 children ward placement, male/female ward segregation, override authority, bed lock, admissionNo, notifications, and auditLogs.",
