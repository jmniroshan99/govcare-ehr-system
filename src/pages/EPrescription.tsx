...
export function EPrescription() {
  ...
  function generatePrescriptionPdf() {
    ...
    doc.text("PostgreSQL API custom-claim signing required in production", 120, finalY + 73);

    doc.setFontSize(8);
    doc.setTextColor(95, 111, 105);
    doc.text("This demo PDF is generated client-side. Production signing/issuing should be validated by PostgreSQL API Spring Boot services with audit logs.", 14, 286);
        ...
        <SectionReveal>
          <Card>
            ...
            <CardContent className="grid gap-3 text-sm md:grid-cols-3">
              <p className="help-strip p-3">Doctors create/sign prescriptions using JWT role claims and PostgreSQL permissions; pharmacists verify, substitute approved alternatives, issue, and update stock.</p>
