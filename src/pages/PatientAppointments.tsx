          ...
          <Card>
            ...
            <CardContent className="space-y-5">
              ...
              <div className="rounded-md border border-border bg-white p-4">
                ...
                <SmartSearch className="mb-3" value={doctorSearch} onChange={setDoctorSearch} navigateOnSelect={false} placeholder="Search doctor, specialty, language..." scope="users" />
