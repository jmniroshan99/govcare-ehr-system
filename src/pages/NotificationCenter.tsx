...
export function NotificationCenter() {
  ...
  async function testDesktopPopup() {
    ...
    addNotification({
      ...
      message: "This is a PostgreSQL API-style desktop popup for urgent EHR alerts.",
    ...
    <div className="space-y-5">
      ...
      <Card>
        ...
        <CardContent className="grid gap-3 lg:grid-cols-[1fr_180px_180px]">
          <SmartSearch value={query} onChange={setQuery} placeholder={t("notificationsPage.searchPlaceholder")} scope="notifications" />
      ...
      <Card className="border-cyan-200 bg-cyan-50/60">
        <CardContent className="flex flex-wrap items-center justify-between gap-3">
          <div>
            <p className="font-bold text-slate-950">PostgreSQL API desktop popup status</p>
