...
import { Activity, Clock3, Download, FileSpreadsheet, FileText, LogIn, MonitorCheck, Printer, Search, ShieldAlert, Users } from "lucide-react";
    ...
    <div className="space-y-5">
      ...
      <Card>
        ...
        <CardContent className="grid gap-3 md:grid-cols-2 xl:grid-cols-7">
          <label className="relative xl:col-span-2"><Search className="absolute left-3 top-3 h-4 w-4 text-muted-foreground" /><Input className="pl-9" value={search} onChange={(e) => { setSearch(e.target.value); setPage(1); }} placeholder="Name, email, user, IP..." /></label>
