        ...
        <section className="grid gap-4 xl:grid-cols-3">
          ...
          <Card>
            ...
            <CardContent className="space-y-3 text-sm">
              ...
              <p className="text-muted-foreground">Production storage should use Spring Boot API authorization, role JWT role claims, API request validation, encrypted message payloads, and immutable audit logs for every view, send, edit, upload, and download.</p>
            </CardContent>
          </Card>
        </section>
