      ...
      <div className="space-y-5">
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                ...
                <div className="grid gap-3 md:grid-cols-[1fr_190px_auto]">
                  <SmartSearch value={search} onChange={setSearch} placeholder="Search patient, request, test, barcode" scope="laboratory" />
        ...
        <section className="grid gap-4 xl:grid-cols-3">
          ...
          <Card>
            ...
            <CardContent className="space-y-2 text-sm text-muted-foreground">
              <p>JWT role claims and PostgreSQL permissions, hospitalId isolation, API request validation, AES-256-GCM sensitive fields, signed reports, immutable audit logs, and least-privilege access are enforced in the production design.</p>
              <div className="flex flex-wrap gap-2"><Badge tone="success">API request validation</Badge><Badge tone="warning">Restricted serology</Badge><Badge tone="success">Audit every action</Badge></div>
            </CardContent>
          </Card>
          <Card>
