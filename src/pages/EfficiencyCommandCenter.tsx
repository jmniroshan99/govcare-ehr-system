...
const upgrades = [
  {
    ...
    implementation: "Use indexed search fields in patients, guardians, and patientIdentifiers. Run final duplicate validation in a Cloud Function.",
    icon: Search,
    priority: "Critical",
  ...
  },
  {
    ...
    implementation: "Store alert rules in clinicalRules. Evaluate sensitive actions through callable Cloud Functions and write immutable audit logs.",
    icon: AlertTriangle,
    priority: "Critical",
  ...
  },
  {
    ...
    implementation: "Maintain patientSummaries documents updated by Cloud Functions when clinical records change.",
    icon: HeartPulse,
    priority: "High",
  ...
  },
  {
    ...
    implementation: "Write aggregated commandCenterStats via scheduled and trigger-based Cloud Functions.",
    icon: Activity,
    priority: "High",
    route: "/",
  },
  {
    ...
    implementation: "Use consents collection, Firebase Storage for signed files, and audit every view/sign/download event.",
    icon: FileText,
    priority: "High",
  ...
  },
  {
    ...
    implementation: "Use guardians and guardianPatients mapping with strict Firestore rules for linked patient access only.",
    icon: UsersRound,
    priority: "High",
    route: "/guardians",
  },
  ...
  },
  {
    ...
    implementation: "Use scheduled Cloud Functions, Storage backup buckets, export audit logs, and admin-only actions.",
    icon: Database,
    priority: "High",
    route: "/reports",
  },
...
const statusRows = [
  ["Duplicate prevention", "patients, guardians, patientIdentifiers", "Cloud Function validation", "Ready to implement"],
...
export function EfficiencyCommandCenter() {
  return (
    <div className="space-y-6">
        ...
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div className="max-w-3xl">
            ...
            <p className="mt-3 text-sm leading-6 text-teal-50">
              A practical upgrade map for faster clinical decisions, safer patient identification, fewer manual steps, and scalable Firebase-backed hospital operations.
            </p>
          </div>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Firebase production structure</CardTitle>
        </CardHeader>
