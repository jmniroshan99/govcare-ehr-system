...
if (major === 22 || major === 24) {
  console.log(`Node.js ${process.version} is supported for GovCare EHR Firebase setup.`);
  process.exit(0);
}

if (major >= 25) {
  console.warn(`Node.js ${process.version} detected. Firebase Functions may not support Node ${major} yet.`);
