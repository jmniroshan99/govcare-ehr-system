...
Production Cloud Functions should reject adult male/female/children cross-assignment unless an authorized clinical override is recorded with reason, approver, timestamp, and audit log.
