...
The app now unregisters legacy service workers after first paint and retries the encrypted offline queue through normal online events; no service-worker cache is retained.
